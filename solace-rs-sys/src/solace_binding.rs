...
pub const SOLCLIENT_GLOBAL_PROP_DEFAULT_SSL_LIB_MACOSX: &[u8; 15] = b"libssl.3.dylib\0";
pub const SOLCLIENT_GLOBAL_PROP_DEFAULT_SSL_LIB_VMS: &[u8; 20] = b"SSL1$LIBSSL_SHR.EXE\0";
pub const SOLCLIENT_GLOBAL_PROP_DEFAULT_SSL_LIB_WINDOWS: &[u8; 13] = b"libssl-3.dll\0";
pub const SOLCLIENT_GLOBAL_PROP_DEFAULT_CRYPTO_LIB_UNIX: &[u8; 13] = b"libcrypto.so\0";
pub const SOLCLIENT_GLOBAL_PROP_DEFAULT_CRYPTO_LIB_MACOSX: &[u8; 18] = b"libcrypto.3.dylib\0";
pub const SOLCLIENT_GLOBAL_PROP_DEFAULT_CRYPTO_LIB_VMS: &[u8; 23] = b"SSL1$LIBCRYPTO_SHR.EXE\0";
pub const SOLCLIENT_GLOBAL_PROP_DEFAULT_CRYPTO_LIB_WINDOWS: &[u8; 16] = b"libcrypto-3.dll\0";
...
pub const SOLCLIENT_CONTEXT_PROP_THREAD_AFFINITY_CPU_LIST: &[u8; 33] =
    b"CONTEXT_THREAD_AFFINITY_CPU_LIST\0";
...
pub const SOLCLIENT_CONTEXT_PROP_DEFAULT_THREAD_AFFINITY_CPU_LIST: &[u8; 1] = b"\0";
...
pub const SOLCLIENT_SESSION_PROP_PAYLOAD_COMPRESSION_LEVEL: &[u8; 34] =
    b"SESSION_PAYLOAD_COMPRESSION_LEVEL\0";
...
pub const SOLCLIENT_SESSION_PROP_DEFAULT_PAYLOAD_COMPRESSION_LEVEL: &[u8; 2] = b"0\0";
...
pub const SOLCLIENT_SESSION_PROP_SSL_PROTOCOL_TLSV1_3: &[u8; 8] = b"TLSv1.3\0";
...
pub const SOLCLIENT_SESSION_PROP_MINIMUM_TLS_PROTOCOL_VERSION: &[u8; 37] =
    b"SESSION_MINIMUM_TLS_PROTOCOL_VERSION\0";
pub const SOLCLIENT_SESSION_PROP_MAXIMUM_TLS_PROTOCOL_VERSION: &[u8; 37] =
    b"SESSION_MAXIMUM_TLS_PROTOCOL_VERSION\0";
pub const SOLCLIENT_SESSION_PROP_DEFAULT_MINIMUM_TLS_PROTOCOL_VERSION: &[u8; 8] = b"TLSv1.2\0";
pub const SOLCLIENT_SESSION_PROP_DEFAULT_MAXIMUM_TLS_PROTOCOL_VERSION: &[u8; 1] = b"\0";
...
pub const SOLCLIENT_CONTEXT_PROP_MAX_CPU_LIST_LEN: u32 = 255;
...
pub const SOLCLIENT_SESSION_DEFAULT_PROP_SSL_PROTOCOL: &[u8; 1] = b"\0";
...
pub const SOLCACHE_INVALID_TOPICSEQUENCE_NUMBER: u32 = 0;
...
pub type solClient_propertyArray_pt = *mut *mut ::std::os::raw::c_char;
...
#[doc = "< A guaranteed message was rejected because the broker has been configured to reject messages when sync replication mode is ineligible. A transaction commit failed because replication became ineligible during the transaction."]
pub const solClient_subCode_SOLCLIENT_SUBCODE_SYNC_REPLICATION_INELIGIBLE: solClient_subCode = 161;
#[doc = "< The client has attempted to publish to a topic that matched a queue or topic endpoint subscription which has its ingress flow shutdown."]
pub const solClient_subCode_SOLCLIENT_SUBCODE_ENDPOINT_SHUTDOWN: solClient_subCode = 162;
#[doc = "< Fail and Reject message settlement outcomes not supported on the Solace Message Router."]
pub const solClient_subCode_SOLCLIENT_SUBCODE_AD_APP_ACK_FAILED_NOT_SUPPORTED: solClient_subCode =
    163;
#[doc = "< The client has attempted to bind a flow to a durable queue or topic endpoint with SOLCLIENT_FLOW_PROP_BIND_ENTITY_DURABLE disabled."]
pub const solClient_subCode_SOLCLIENT_SUBCODE_INVALID_DURABILITY: solClient_subCode = 164;
...
extern "C" {
    pub static mut _solClient_log_appFilterLevel_g: solClient_log_level_t;
}
extern "C" {
    pub fn _solClient_log_output_detail(
        category: solClient_log_category_t,
        level: solClient_log_level_t,
        filename_p: *const ::std::os::raw::c_char,
        lineNum: ::std::os::raw::c_int,
        format_p: *const ::std::os::raw::c_char,
        ...
    );
}
extern "C" {
    pub fn _solClient_log_output_detail_va_list(
        category: solClient_log_category_t,
        level: solClient_log_level_t,
        filename_p: *const ::std::os::raw::c_char,
        lineNum: ::std::os::raw::c_int,
...
extern "C" {
    pub static mut _solClient_contextPropsDefaultWithCreateThread:
...
pub type solClient_errorInfo_t = solClient_errorInfo;
...
pub type solClient_stats_t = solClient_uint64_t;
pub type solClient_stats_pt = *mut solClient_uint64_t;
#[doc = "< The number of bytes received in Direct messages."]
...
#[doc = "< The number of Direct messages received."]
...
#[doc = "< The number of bytes received before decompression. This metric only applies to transport/channel compression"]
...
#[doc = "< The number of bytes transmitted after compression. This metric only applies to transport/channel compression"]
...
#[doc = " @struct solClient_session_eventCallbackInfo\n\n A structure that is returned (as a pointer) for each event in the event\n callback for a Session. A structure is used so that new fields\n can be added in the future without affecting existing applications.\n For a sessionEvent of ::SOLCLIENT_SESSION_EVENT_ACKNOWLEDGEMENT, info_p\n will be the pointer or value set by ::solClient_msg_setCorrelationTag()\n or ::solClient_msg_setCorrelationTagPtr() in the message that is being\n acknowledged. This is used to correlate a published message to\n the acknowledgment received from\n the broker. In all other events info_p is a pointer to a NULL-terminated\n string."]
pub type solClient_session_eventCallbackInfo_t = solClient_session_eventCallbackInfo;
#[doc = " @struct solClient_session_eventCallbackInfo\n\n A structure that is returned (as a pointer) for each event in the event\n callback for a Session. A structure is used so that new fields\n can be added in the future without affecting existing applications.\n For a sessionEvent of ::SOLCLIENT_SESSION_EVENT_ACKNOWLEDGEMENT, info_p\n will be the pointer or value set by ::solClient_msg_setCorrelationTag()\n or ::solClient_msg_setCorrelationTagPtr() in the message that is being\n acknowledged. This is used to correlate a published message to\n the acknowledgment received from\n the broker. In all other events info_p is a pointer to a NULL-terminated\n string."]
...
#[doc = " @struct solClient_flow_eventCallbackInfo\n\n A structure that is returned (as a pointer) for each event in the event callback\n callback for a Flow. A structure is used so that new fields can be added\n in the future without affecting existing applications."]
pub type solClient_flow_eventCallbackInfo_t = solClient_flow_eventCallbackInfo;
#[doc = " @struct solClient_flow_eventCallbackInfo\n\n A structure that is returned (as a pointer) for each event in the event callback\n callback for a Flow. A structure is used so that new fields can be added\n in the future without affecting existing applications."]
...
#[doc = " @struct solClient_log_callbackInfo_t\n\n A structure that is returned (as a pointer) for each log to the log callback routine\n that has been optionally registered. A structure is used so that new fields can be added\n in the future without affecting existing applications."]
pub type solClient_log_callbackInfo_t = solClient_log_callbackInfo;
#[doc = " @struct solClient_log_callbackInfo_t\n\n A structure that is returned (as a pointer) for each log to the log callback routine\n that has been optionally registered. A structure is used so that new fields can be added\n in the future without affecting existing applications."]
...
pub struct solClient_session_rxMsgDispatchFuncInfo {
    ...
    #[doc = "< An application-defined callback function; may be NULL in which case the default session receive message callback is used."]
    pub callback_p: solClient_session_rxMsgCallbackFunc_t,
...
pub struct solClient_flow_rxMsgDispatchFuncInfo {
    #[doc = "< The type of dispatch described"]
    pub dispatchType: solClient_dispatchType_t,
    #[doc = "< An application-defined callback function; may be NULL in which case the default flow receive message callback is used."]
    pub callback_p: solClient_flow_rxMsgCallbackFunc_t,
    #[doc = "< A user pointer to return with the callback; must be NULL if callback_p is NULL"]
    pub user_p: *mut ::std::os::raw::c_void,
    #[doc = "< Reserved for future use; must be NULL."]
...
#[doc = " @struct solClient_version_info\n\n A structure returned from solClient_version_get that contains version information.\n All the returned pointers are never NULL when returned from solClient_version_get.\n\n @see solClient_version_get()"]
pub type solClient_version_info_t = solClient_version_info;
#[doc = " @struct solClient_version_info\n\n A structure returned from solClient_version_get that contains version information.\n All the returned pointers are never NULL when returned from solClient_version_get.\n\n @see solClient_version_get()"]
...
pub type solClient_session_V1createFuncInfo_t = solClient_session_V1createFuncInfo;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct solClient_flow_V1createFuncInfo {
    pub rxInfo: solClient_flow_createRxCallbackFuncInfo_t,
    pub eventInfo: solClient_flow_createEventCallbackFuncInfo_t,
}
#[test]
fn bindgen_test_layout_solClient_flow_V1createFuncInfo() {
    const UNINIT: ::std::mem::MaybeUninit<solClient_flow_V1createFuncInfo> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<solClient_flow_V1createFuncInfo>(),
        32usize,
        concat!("Size of: ", stringify!(solClient_flow_V1createFuncInfo))
    );
    assert_eq!(
        ::std::mem::align_of::<solClient_flow_V1createFuncInfo>(),
        8usize,
        concat!("Alignment of ", stringify!(solClient_flow_V1createFuncInfo))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).rxInfo) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(solClient_flow_V1createFuncInfo),
            "::",
            stringify!(rxInfo)
        )
    );
...
pub type solClient_flow_V1createFuncInfo_t = solClient_flow_V1createFuncInfo;
extern "C" {
...
#[doc = " @struct solClient_sendMultiple\n\n A structure used to describe a single message. This is used as part of the solClient_session_sendMultiple()\n call. Note that this only allows a Topic message to be sent with a binary payload. Use\n multiple calls to solClient_session_send() to send other message types."]
pub type solClient_sendMultiple_t = solClient_sendMultiple;
#[doc = " @struct solClient_sendMultiple\n\n A structure used to describe a single message. This is used as part of the solClient_session_sendMultiple()\n call. Note that this only allows a Topic message to be sent with a binary payload. Use\n multiple calls to solClient_session_send() to send other message types."]
...
fn bindgen_test_layout_solClient_session_rxCallbackInfo() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).rcvTimestamp) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(solClient_session_rxCallbackInfo),
            "::",
            stringify!(rcvTimestamp)
        )
    );
}
#[doc = " Old documentation for solClient_session_createFuncInfo\n\n If the application uses the <i>rxInfo</i> callback interface, then the\n application callback will have the interface (see ::solClient_session_rxCallbackFunc_t):\n\n <code style=\"font-size:90%\">\nvoid\napplicationRxDataCallback ( solClient_opaqueSession_pt                opaqueSession_p,\nsolClient_bufInfo_pt                      bufInfo_p,\nsolClient_session_rxCallbackInfo_pt       rxInfo_p,\nvoid                                     *user_p);\n </code>\n\n\n\n/\n/**\n @struct solClient_session_rxCallbackInfo\n\n A structure that is returned (as a pointer) with each received message in\n the message receive callback for a Session. A structure is used\n so that new fields can be added in the future without affecting existing\n applications."]
pub type solClient_session_rxCallbackInfo_t = solClient_session_rxCallbackInfo;
#[doc = " Old documentation for solClient_session_createFuncInfo\n\n If the application uses the <i>rxInfo</i> callback interface, then the\n application callback will have the interface (see ::solClient_session_rxCallbackFunc_t):\n\n <code style=\"font-size:90%\">\nvoid\napplicationRxDataCallback ( solClient_opaqueSession_pt                opaqueSession_p,\nsolClient_bufInfo_pt                      bufInfo_p,\nsolClient_session_rxCallbackInfo_pt       rxInfo_p,\nvoid                                     *user_p);\n </code>\n\n\n\n/\n/**\n @struct solClient_session_rxCallbackInfo\n\n A structure that is returned (as a pointer) with each received message in\n the message receive callback for a Session. A structure is used\n so that new fields can be added in the future without affecting existing\n applications."]
pub type solClient_session_rxCallbackInfo_pt = *mut solClient_session_rxCallbackInfo;
#[doc = " A structure that is returned (as a pointer) with each received message in\n the message receive callback for a Flow. A structure is used\n so that new fields can be added in the future without affecting existing\n applications. Note that this structure is the same as ::solClient_session_rxCallbackInfo."]
pub type solClient_flow_rxCallbackInfo_t = solClient_session_rxCallbackInfo_t;
#[doc = " A structure that is returned (as a pointer) with each received message in\n the message receive callback for a Flow. A structure is used\n so that new fields can be added in the future without affecting existing\n applications. Note that this structure is the same as ::solClient_session_rxCallbackInfo."]
pub type solClient_flow_rxCallbackInfo_pt = *mut solClient_session_rxCallbackInfo_t;
...
pub type solClient_flow_rxCallbackFunc_t = ::std::option::Option<
    unsafe extern "C" fn(
        opaqueFlow_p: solClient_opaqueFlow_pt,
        bufInfo_p: solClient_bufInfo_pt,
        rxInfo_p: solClient_flow_rxCallbackInfo_pt,
        user_p: *mut ::std::os::raw::c_void,
    ),
>;
...
pub type solClient_session_rxCallbackFunc_t = ::std::option::Option<
    unsafe extern "C" fn(
        opaqueSession_p: solClient_opaqueSession_pt,
        bufInfo_p: solClient_bufInfo_pt,
        rxInfo_p: solClient_session_rxCallbackInfo_pt,
        user_p: *mut ::std::os::raw::c_void,
    ),
>;
extern "C" {
...
extern "C" {
    pub fn _solClient_log_output_va_list(
        category: solClient_log_category_t,
        level: solClient_log_level_t,
        format_p: *const ::std::os::raw::c_char,
        ap: *mut __va_list_tag,
...
pub type solClient_replicationGroupMessageId_t = solClient_replicationGroupMessageId;
...
#[doc = "  SolCache events. The list of events that can be passed to the\n  event callback function."]
...
#[doc = " SolCache event callback information. When the application registers\n an event callback pointer with a cache request (for asynchronous cache\n requests), the callback function receives a pointer to the event\n callback information structure."]
pub type solCache_eventCallbackInfo_t = solCache_eventCallbackInfo;
#[doc = " SolCache event callback information. When the application registers\n an event callback pointer with a cache request (for asynchronous cache\n requests), the callback function receives a pointer to the event\n callback information structure."]
pub type solCache_eventCallbackInfo_pt = *mut solCache_eventCallbackInfo;
#[doc = " A prototype for the eventCallback function that can be registered by the\n application."]
